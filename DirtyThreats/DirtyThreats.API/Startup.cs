using DirtyThreats.API.Common.Attributes;
using DirtyThreats.API.Common.Middlewares;
using DirtyThreats.API.Common.Settings;
using DirtyThreats.API.Swagger;
using DirtyThreats.IoC.Configuration.DI;
